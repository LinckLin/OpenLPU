...
#   design : synth_datapath | mac_bf16 | matrix_int8_pe | matrix_int8_pe_tile | matrix_int8_pe_array | synth_top
...
case "$DESIGN" in
  synth_datapath|mac_bf16|matrix_int8_pe|matrix_int8_pe_tile|matrix_int8_pe_array)
